...
To win the game, you must collect all required items, solve the puzzle to unlock the computer lab, and use all items at the lab. Here is the complete walkthrough:
...
List of commands to lose (by exceeding move limit - repeating go east and go west 50 times):
